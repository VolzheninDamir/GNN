# optuna_sageconv_edge_no_prune.py (исправленный)
import os
import torch
...
def main():
    ...
    study = optuna.create_study(
        direction='minimize',
        study_name='sageconv_edge_hyperopt_no_prune',
    ...
    print("\n=== Результаты поиска для SAGEConv с поддержкой рёбер ===")
    ...
    with open("best_params_sageconv_edge.yaml", "w") as f:
        yaml.dump(best_params, f, default_flow_style=False)
    print("\nЛучшие параметры сохранены в best_params_sageconv_edge.yaml")
